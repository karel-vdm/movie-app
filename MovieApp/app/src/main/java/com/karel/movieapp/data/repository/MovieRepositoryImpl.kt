...
class MovieRepositoryImpl(
    ...
    override fun getSavedState(): Flow<MovieListModel>? {
        return movieDao.getSavedState()
    }

    override fun getMoviesFromCache(): Flow<List<MovieListItemModel>>? {
        return movieDao.getMovies()
    }

    override suspend fun saveCurrentState(movie: MovieListModel) {
